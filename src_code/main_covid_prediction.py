...
USE_PREPROCESS_AUGMENTED_CUSTOM_DATASET = True # True, to use dataset generated by 'tool_data_gen.py'
PRINT_SAMPLES = True
    ...
    "CUSTOM-MODEL": {
        ...
        "config":
            PredictorConfiguration(
                ...
                EARLY_STOPPING_DECLINE_CRITERION=100,
            ),
        "transformation":
            transforms.Compose([
                # same:
...
N_TEST = 400
if USE_PREPROCESS_CUSTOM_DATASET or USE_PREPROCESS_AUGMENTED_CUSTOM_DATASET:
